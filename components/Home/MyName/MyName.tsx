...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
<p>
    I'm a <span className="text-AAsecondary">Software Engineer</span> with a strong aptitude for problem-solving and a passion for crafting exceptional <br className="2xl:block hidden" />
    digital experiences. My expertise lies in <span className="text-AAsecondary">Full Stack Development</span>, where I specialize in building <br className="2xl:block hidden" />
    robust and scalable web applications. This involves working with <span className="text-AAsecondary">Frontend</span> and <span className="text-AAsecondary">Backend</span> technologies.
</p>
