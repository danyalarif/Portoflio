...
export default function Home() {
  ...
  const meta = {
    title: "Danyal Arif - Software Engineer",
    description: `I am a passionate Software Engineer. Get in touch with me to know more.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://danyalarif.com`} />
        <link rel="canonical" href={`https://danyalarif.com`} />
      ...
      <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
        ...
        {context.sharedState.finishedLoading ? (
          <Footer
            githubUrl={"https://github.com/danyalarif"}
